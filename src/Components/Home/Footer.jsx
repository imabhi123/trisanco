        ...
        <div className='main_footer_component'>
            <div className="main_footer_component_first_part">
                <div className="main_footer_component_first_part_top" style={{ paddingBottom: '80px' }}>
                    <div style={{ flex: '1.5' }}>
                        <p style={{fontSize:'46px' , fontWeight:'700',color:'white',margin:'0'}}>Trisanco</p>
                    ...
                    <div style={{ position: 'relative', bottom: '20px' }}>
                        ...
                        <p className="footer_text_small">Madhya pradesh,Bhopal,Shri ram colony,Hoshangabaad road</p>
                        <p className="footer_text_small" style={{color:'white',cursor:'pointer'}}>+91 9685507081</p>
